...
def test_compare_reports_gpt4o_writes_comparison_json(
    ...
    assert "page" not in match_prompt["previous_tables"][0]
    assert "headers" not in match_prompt["previous_tables"][0]
    assert "rows" not in match_prompt["previous_tables"][0]
