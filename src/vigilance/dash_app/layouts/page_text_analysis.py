...
Le rendu est reparti dans le sous-package ``text_analysis`` : libelles et badges,
surlignage des segments modifies, carte de changement et bandeau executif.
...
from vigilance.analyst_change_presentation import change_scope
...
from .text_analysis.change_card import (  # noqa: F401 - re-export de compatibilite
    _ai_detail_item,
    _build_ai_details,
    _build_change_card,
    _build_observed_block,
    _build_side_by_side,
    _first_complete_sentence,
    _impact_domain,
)
from .text_analysis.highlight import (  # noqa: F401 - re-export de compatibilite
...
from .text_analysis.labels import (  # noqa: F401 - re-export de compatibilite
    _ACTION_BADGE,
    _DIFF_LABELS,
    _IMPACT_BADGE,
    _IMPACT_ORDER,
...
from .text_analysis.overview import (  # noqa: F401 - re-export de compatibilite
    _build_executive_banner,
    _build_executive_overview_text,
    _build_text_review_progress,
    _count_auditable_text_changes,
    _text_review_progress,
)
