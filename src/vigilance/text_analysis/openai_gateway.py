"""Passerelle OpenAI, parsing JSON et politiques de retry."""
...
from .constants import _MODEL_MAX_OUTPUT_TOKENS, _OPENAI_TIMEOUT_SECONDS, _TRIAGE_LENGTH_RETRIES, _TRIAGE_TRANSPORT_RETRIES
    ...
    return list(messages) + [
        {
            ...
            "content": (
                ...
                "si obligatoire. Tous les champs textuels libres doivent rester "
                "en français professionnel; les clés JSON et valeurs d'énumération "
                "restent inchangées. Ne répète pas la taxonomie, ne cite pas de longs "
            ...
            current_messages = current_messages + [
                {
                    ...
                    "content": (
                        ...
                        "Tous les champs textuels libres doivent rester en français "
                        "professionnel; les clés JSON, codes et enums restent inchangés."
                    ),
                }
            ]
