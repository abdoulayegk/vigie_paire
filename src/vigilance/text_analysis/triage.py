...
L'implementation est repartie dans le sous-package ``triage_parts`` : constantes,
paquets de preuve, redaction analyste, themes AMF, exclusions deterministes,
alignement semantique, resultats et deduplication. Ce module reste la facade
publique et re-exporte tout ce qui etait accessible avant le decoupage.
"""
...
from vigilance.text_analysis.constants import _TRIAGE_BATCH_SIZE, _TRIAGE_SOURCE_SNIPPET_LIMIT
...
from .triage_parts.alignment import (  # noqa: F401 - re-export de compatibilite
...
from .triage_parts.analyst_copy import (  # noqa: F401 - re-export de compatibilite
    _analyst_exclusion_copy,
    _ensure_bank_subject,
    _excerpt_for_analyst,
    _local_relevance_reason,
    _normalize_local_analyst_field,
    _secondary_analyst_justification,
    _semantic_reason_payload,
)
from .triage_parts.constants import (  # noqa: F401 - re-export de compatibilite
...
from .triage_parts.dedup import (  # noqa: F401 - re-export de compatibilite
    _FEW_SHOT_TRIAGE_AMF,
    _changes_compatible_for_dedup,
    _cosine_similarity,
    _group_semantic_triage_duplicates,
    _propagate_triage_to_group,
    _triage_retrieval_text,
)
from .triage_parts.evidence import (  # noqa: F401 - re-export de compatibilite
    ...
    _split_full_evidence_text,
)
from .triage_parts.exclusions import (  # noqa: F401 - re-export de compatibilite
    _combined_change_text,
    _deterministic_bank_specific_exclusion,
    _deterministic_cosmetic_exclusion,
    _has_calendar_reschedule_context,
    _has_methodology_signal,
    _has_new_regulatory_substance,
    _is_isolated_date_change,
    _is_pure_new_regulatory_disclosure,
    _is_semantic_text_move,
    _mask_volatile_tokens,
    _numeric_tokens,
    _regulatory_tokens,
    _sequence_ratio,
    _shares_calendar_subject,
)
from .triage_parts.results import (  # noqa: F401 - re-export de compatibilite
    _COMPACT_HIGH_PRIORITY_THEMES,
    _cosmetic_triage_result,
    _default_triage,
    _derive_legacy_fields,
    _persisted_triage_from_compact,
    _prefilter_triage_result,
)
from .triage_parts.themes import (  # noqa: F401 - re-export de compatibilite
    _candidate_themes_for_change,
    _normalize_for_cosmetic,
