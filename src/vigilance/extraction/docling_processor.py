...
L'implementation est repartie dans le sous-package ``docling`` : structures de
donnees, configuration, dependances optionnelles, et un mixin par passe
d'extraction (docling natif, Vision, titres, sections, plages de pages).
Ce module reste la facade publique et re-exporte ce qui etait accessible avant.
"""
...
from .docling_bbox_helpers import _build_indicator_reference_text  # noqa: F401 - re-export
from .locator_merge_reconciliation import (  # noqa: F401 - re-export de compatibilite
    _is_locator_merge_conflict,
    _reconcile_on_demand_locator_merges,
)
from .docling.config import (  # noqa: F401 - re-export de compatibilite
    _compute_vision_quality_summary,
    _env_bool,
    _resolve_vision_extraction_enabled,
)
from .docling.docling_pass import DoclingPassMixin
from .docling.document import DocumentExtractionMixin
from .docling.models import (  # noqa: F401 - re-export de compatibilite
    ExtractedDocument,
    ExtractedSection,
    ExtractedTable,
)
from .docling.page_ranges import PageRangeMixin
from .docling.runtime import (  # noqa: F401 - re-export de compatibilite
    CACHE_AVAILABLE,
    CHUNK_SIZE_PAGES,
...
from .docling.sections import SectionAssociationMixin
from .docling.titles import TableTitleMixin
