"""Données de détection des sections : motifs regex et listes de référence.

Ce module ne contient que des données ; toute la logique reste dans le localisateur.
"""
