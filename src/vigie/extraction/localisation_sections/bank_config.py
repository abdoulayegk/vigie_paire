"""Accès à la configuration par banque : patterns compilés, overrides et pagination.
...
def _load_bank_config() -> dict:
    ...
    # localisation_sections/ est un niveau plus bas que l'ancien module plat.
...
def _get_bank_section_names(bank_code: str) -> dict:
    """Charge les noms de sections depuis bank_profiles.json (source unique de vérité).
