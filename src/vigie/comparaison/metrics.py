"""Agregation de metriques et signaux qualite pour le pipeline de comparaison."""

from __future__ import annotations

from typing import Any, TypedDict

from vigie.comparaison.io import _coerce_float, _coerce_int
from vigie.support.utils.model_cost import (
