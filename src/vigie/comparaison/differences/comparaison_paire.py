...
from vigie.comparaison.differences.comparaison_llm import (
    diff_footnotes_pair_gpt,
    diff_indicators_pair_gpt,
)
from vigie.comparaison.differences.filtrage_artefacts import (
    _inspect_diff_artifacts_gpt,
)
from vigie.comparaison.differences.normalisation_elements import _normalize_footnotes
